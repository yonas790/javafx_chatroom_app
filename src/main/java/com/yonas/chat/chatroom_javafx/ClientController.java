...
public class ClientController implements Initializable {
	...
	private void handleButtonActionSendFile (ActionEvent event) throws Exception{
		FXMLLoader fxmlLoaderSendFile = new FXMLLoader(getClass().getResource("/com/yonas/chat/chatroom_javafx/SendFile.fxml"));
		...
		sceneSendFile.getStylesheets().add(getClass().getResource("/com/yonas/chat/chatroom_javafx/application.css").toExternalForm());

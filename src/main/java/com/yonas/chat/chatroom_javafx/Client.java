...
public class Client extends Application {
	...
	public void start(Stage primaryStage) {
		try {
			FXMLLoader fxmlLoaderClientLogin = new FXMLLoader(getClass().getResource("/com/yonas/chat/chatroom_javafx/ClientLogin.fxml"));
			...
			sceneLogin.getStylesheets().add(getClass().getResource("/com/yonas/chat/chatroom_javafx/application.css").toExternalForm());

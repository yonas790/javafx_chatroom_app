...
public class Server extends Application {
	...
	public void start(Stage primaryStage) {
		try {
			FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/yonas/chat/chatroom_javafx/Server.fxml"));
			Parent root = (Parent)fxmlLoader.load(); 
			ServerController svc = fxmlLoader.<ServerController>getController();
			
			FXMLLoader fxmlLoaderUser = new FXMLLoader(getClass().getResource("/com/yonas/chat/chatroom_javafx/Users.fxml"));
			...
			scene.getStylesheets().add(getClass().getResource("/com/yonas/chat/chatroom_javafx/application.css").toExternalForm());
